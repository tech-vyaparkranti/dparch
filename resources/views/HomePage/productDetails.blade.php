            ...
            <div class="project-details-wrapper">
                ...
                <div class="project-main-content">
                    ...
                    <div class="project-header">
                        ...
                        <span class="project-category">{{ $projectDetails->category ?? 'Adventure' }}</span>
                        <span class="project-date">{{ $projectDetails->created_at ? $projectDetails->created_at->format('M Y') : 'Recent' }}</span>
                    </div> --}}
                    ...
                    <div class="project-description">
                        <div class="description-content">
                            {!! $projectDetails->description ??
                                '<p>Embark on an extraordinary adventure that will challenge your limits and reward you with unforgettable memories. Our expertly crafted expedition combines breathtaking landscapes, cultural immersion, and thrilling activities designed for adventurers of all skill levels.</p>
                                                    <p>This comprehensive journey takes you through some of the most spectacular terrains, offering unique opportunities to connect with nature while experiencing the local culture and traditions. Our experienced guides ensure your safety while maximizing your adventure experience.</p>
                                                    <p>Whether you\'re seeking personal challenge, natural beauty, or cultural enrichment, this project delivers an all-encompassing adventure that will leave you with stories to tell for a lifetime.</p>' !!}
                        </div>
                    </div>
                    ...
                    @php
                        $galleryImages = is_array($projectDetails->gallery_images)
                            ? $projectDetails->gallery_images
                            : json_decode($projectDetails->gallery_images, true);
                    @endphp
                                ...
                                @foreach ($galleryImages as $index => $image)
                                    <div class="gallery-item" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                                        ...
                                        {{-- <div class="gallery-overlay">
                                            <button class="gallery-btn" onclick="openLightbox({{ $index }})">
                                    ...
                                    <div class="recent-project-item">
                                        <div class="recent-project-image">
                                            <img src="{{ asset($recentProject->image) }}"
                                                alt="{{ $recentProject->project_name }}">
                                        </div>
                                        <div class="recent-project-content">
                                            <h4><a
                                                    href="{{ route('productDetails', $recentProject->slug) }}">{{ $recentProject->project_name }}</a>
                                            </h4>
                                            <p>{{ Str::limit(strip_tags($recentProject->description), 80) }}</p>
                                            <span
